...
<section class="content">
    <div class="box box-info no-print">
        ...
        <div class="box-body">
            <form method="post" action="<?php echo site_url('supervisor-details-list'); ?>" id="frmsearch">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <?php echo form_dropdown(
                                'srch_supervisor_id',
                                $name_opt + array('' => 'All'),
                                set_value('srch_supervisor_id', $srch_supervisor_id),
                                'class="form-control" id="srch_supervisor_id"'
                            ); ?>
                ...
                <tbody>
                    <?php foreach ($record_list as $j => $ls) { ?>
                        <tr>
                            ...
                            <td><a href="tel:<?php echo $ls['mobile']; ?>"> <?php echo $ls['mobile']; ?></a>
                            </td>
                            <td>
                                <?php
                                if ($ls['status'] == 'Active') {
                            ...
                            <td class="text-center">
                                <a href="<?php echo site_url('supervisor-details-edit/' . $ls['supervisor_id']); ?>"
                                    class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a>
                            </td>

                            <td class="text-center">
                                <button value="<?php echo $ls['supervisor_id']; ?>" class="del_record btn btn-danger btn-xs"
