    ...
    <div class="box box-success">
        ...
        <div class="box-body table-responsive">
                ...
                <tbody>
                    ...
                    foreach ($record_list as $j => $ls) {
                        ...
                        <tr class="mb-3">
                            ...
                            <td><?php echo $ls['hobbies_name'] ?></td>
                            <td><?php echo $ls['status'] ?></td>
                            <td class="text-center">
                                <button data-toggle="modal" data-target="#edit_modal"
                                    value="<?php echo $ls['hobbies_list_id'] ?>"
                                    class="edit_record btn btn-primary btn-xs" title="Edit"><i
                                        class="fa fa-edit"></i></button>
                            </td>
                            <td class="text-center">
                                <button value="<?php echo $ls['hobbies_list_id'] ?>"
            ...
            <div class="modal fade" id="add_modal" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo site_url('hobbies-list'); ?>" id="frmadd"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="hobbies_name" id="hobbies_name"
            ...
            <div class="modal fade" id="edit_modal" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo site_url('hobbies-list'); ?>" id="frmedit"
                            class="form-material">
                            <div class="modal-header">
                                ...
                                <input type="hidden" name="hobbies_list_id" id="hobbies_list_id" value="" />
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
