    ...
    <div class="box box-success">
        ...
        <div class="box-body table-responsive">
                ...
                <tbody>
                    ...
                    foreach ($record_list as $j => $ls) {
                        ...
                        <tr class="mb-3">
                            ...
                            <td><?php echo $ls['talent_name'] ?></td>
                            <td><?php echo $ls['status'] ?></td>
                            <td class="text-center">
                                <button data-toggle="modal" data-target="#edit_modal"
                                    value="<?php echo $ls['talent_id'] ?>"
                                    class="edit_record btn btn-primary btn-xs" title="Edit"><i
                                        class="fa fa-edit"></i></button>
                            </td>
                            <td class="text-center">
                                <button value="<?php echo $ls['talent_id'] ?>"
            ...
            <div class="modal fade" id="add_modal" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo site_url('talent-list'); ?>" id="frmadd"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="talent_name" id="talent_name"
            ...
            <div class="modal fade" id="edit_modal" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <form method="post" action="<?php echo site_url('talent-list'); ?>" id="frmedit"
                            class="form-material">
                            <div class="modal-header">
